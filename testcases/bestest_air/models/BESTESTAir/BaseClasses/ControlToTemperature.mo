...
equation
  connect(gain.y, add.u1)
    annotation (Line(points={{1,20},{10,20},{10,8},{18,8}}, color={0,0,127}));
  connect(add.y, T) annotation (Line(points={{41,2},{76,2},{76,0},{110,0}},
                                                              color={0,0,127}));
  connect(const.y, add.u2) annotation (Line(points={{1,-20},{10,-20},{10,-4},{
          18,-4}},
                color={0,0,127}));
